...
the marginal distribution for any particular parameter(s) of interest. If the
...
models that varies between frames is a conclusion that is uncertain, and any
feature that is common to all models in the sample is a feature that has a high
