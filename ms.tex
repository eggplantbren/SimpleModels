...
true value of $F$ is 1, and the inferred values of $F$ are
$(0.9401 \pm 0.0072)$ and $(0.9404 \pm 0.0083)$
respectively. The true value is an $8.3-\sigma$ outlier from the posterior
using the simple model, and this is only reduced to $7.2-\sigma$ by the
